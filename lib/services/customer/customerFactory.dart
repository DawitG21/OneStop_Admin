...
import 'package:onestopservices/models/customer/customer_create.dart';
import 'package:onestopservices/models/customer/customer_search.dart';
import 'package:onestopservices/services/customer/customerService.dart';
...
class CustomerFactory with ChangeNotifier {
  ...
  Future<CustomerCreate> createCustomer(
    status,
    name,
    email,
    username,
