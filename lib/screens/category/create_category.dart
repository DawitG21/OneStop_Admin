...
import 'package:onestopservices/models/discount/discount_catagory.dart';
import 'package:onestopservices/models/seo/seo.dart';
import 'package:onestopservices/models/skills/skills.dart';
import 'package:onestopservices/models/tax/tax.dart';
import 'package:onestopservices/models/tax/tax_catagory.dart';
...
class CreateCategoryState extends State<CreateCategory> {
  ...
  clear() {
    ...
    _adminCommissionController.clear();
    _agentCommissionController.clear();
